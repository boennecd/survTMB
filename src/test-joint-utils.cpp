...
context("joint-utils unit tests") {
  ...
  test_that("eval_snva_integral gives the correct result with poly") {
   using ADd = AD<double>;
    ...
    arma::vec const norm2 = { 0.1, 1, 8.25, 52.8 },
                alpha_bas = { 5.5, 5.5 };
    ...
    auto x = func.get_x(lb, ub, omega, alpha, B, U, k, Lambda);
    {
      ...
      constexpr double const intgral_val = 2.7947342440166;
      expect_equal(intgral_val, asDouble(y[0L]));
      ...
      constexpr double const grad[n_grad_ele] = {
        2.7947342440166, -0.67970521133651, -0.365662604074403, 3.3197535938997,
        -1.43618529234203, 1.95631397081162, -0.475793647935557, -0.255963822852082,
        1.67684054640996, -0.407823126801906, -0.219397562444642, 1.95631397081162,
        -0.475793647935557, -0.255963822852082, 1.67684054640996, -0.407823126801906,
        -0.219397562444642, 1.89305853520062, -0.298733450779415, -0.540348222431456,
        1.62262160160053, -0.256057243525213, -0.463155619226962, 0.684709889784067,
        -0.166527776777445, -0.0895873379982286, 0.586894191243486, -0.142738094380667,
        -0.0767891468556245, -0.166527776777445, 0.605803959423924, -0.151904764826557,
        -0.142738094380667, 0.519260536649078, -0.130204084137049, -0.0895873379982286,
        -0.151904764826557, 0.480359793492914, -0.0767891468556245, -0.130204084137049,
        0.411736965851069, 0.586894191243486, -0.142738094380667, -0.0767891468556245,
        0.503052163922988, -0.122346938040572, -0.0658192687333925, -0.142738094380667,
        0.519260536649078, -0.130204084137049, -0.122346938040572, 0.445080459984924,
        -0.111603500688899, -0.0767891468556245, -0.130204084137049,
        0.411736965851069, -0.0658192687333925, -0.111603500688899, 0.352917399300916 };
