...
We create a "profile lower bound" plot in 2D as a function of the maternal 
effect parameter and the genetic effect parameter:
...
($\sigma_1$ is the genetic effect parameter and $\sigma_2$ is the maternal 
effect parameter):
